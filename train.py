...
#拟合，训练数据集train_ds，迭代5次，每次迭代批数steps_per_epoch，验证数据集val_ds，回调函数存储每次迭代最优解
history = model.fit(train_ds, epochs=3, steps_per_epoch=steps_per_epoch, validation_data=val_ds, validation_steps=5, callbacks=[cp_callback])
